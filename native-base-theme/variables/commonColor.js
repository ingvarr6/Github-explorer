...
export default {
  ...
  toolbarDefaultBg: platform === "ios" ? "#24292e" : "#24292e",
  ...
  segmentActiveBackgroundColor: platform === "ios" ? "#24292e" : "#24292e",
  segmentTextColor: platform === "ios" ? "#24292e" : "#24292e",
  segmentActiveTextColor: platform === "ios" ? "#fff" : "#fff",
  segmentBorderColor: platform === "ios" ? "#24292e" : "#24292e",
  segmentBorderColorMain: platform === "ios" ? "#24292e" : "#24292e",
  ...
  // Tab
  tabDefaultBg: platform === "ios" ? "#24292e" : "#24292e",
  topTabBarTextColor: platform === "ios" ? "#c8c9cb" : "#c8c9cb",
  topTabBarActiveTextColor: platform === "ios" ? "#fff" : "#fff",
  topTabBarBorderColor: platform === "ios" ? "#a7a6ab" : "#a7a6ab",
  topTabBarActiveBorderColor: platform === "ios" ? "#6a737d" : "#6a737d",
